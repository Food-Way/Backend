...
//        commentRepository.save(commentParent);
    ...
    public ResponseEntity<List<Comment>> getCommentsOfAEstablishment(UUID idEstablishment) {
        List<Comment> comments = commentRepository.findByEstablishment_IdUserOrderByCreatedAtAsc(idEstablishment);
